...
struct movePiece movePieceList[50];
struct newPiece newPieceList[50];

void * newPieceQue[50];
void * movePieceQue[50];
...
void main(void){
    ...
    YKInitialize();
    newPieceQueue = YKQCreate(newPieceQue, 50);
    movePieceQueue = YKQCreate(movePieceQue, 50);
    movePieceSem = YKSemCreate(1);
